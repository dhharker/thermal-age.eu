<div class="jobs index">
	...
	<tr>
			...
			<th><?php echo $this->Paginator->sort('processor_name');?></th>
			<th><?php echo $this->Paginator->sort('parser_name');?></th>
			<th><?php echo $this->Paginator->sort('reporter_name');?></th>
			<th><?php echo $this->Paginator->sort('created');?></th>
			<th><?php echo $this->Paginator->sort('updated');?></th>
			<th><?php echo $this->Paginator->sort('pub_ref');?></th>
	...
	<tr<?php echo $class;?>>
		...
		<td><?php echo $job['Job']['pub_ref']; ?>&nbsp;</td>
